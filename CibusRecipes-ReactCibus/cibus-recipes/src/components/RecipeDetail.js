  ...
  return (
    <Container>
      <Row>
        ...
        <Col>
          <h1 className=" .fs-1 fw-bold my-2 py-4 ">Spaghetti with Sauce</h1>
          ...
          <Row>
            ...
            >
              ...
              sauce. This beloved comfort food is loved for its satisfying taste
              and ease of preparation, making it a go-to choice for both quick
            ...
            >
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Add the spaghetti to the boiling water and cook according to
                    the package instructions until it's al dente (firm to the
                    bite).
                  </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    If the sauce is too acidic, you can add a pinch of sugar to
                    balance the flavors.
                  </li>
                  <li>
                    Reduce the heat to low, cover the skillet, and let the sauce
                    simmer for about 15-20 minutes, stirring occasionally, until
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>Toss the pasta with the sauce until it's well-coated.</li>
                </ul>
              </li>
              <li>
                Serve:
                <ul>
                  <li>Transfer the spaghetti with sauce to serving plates.</li>
                  <li>
                    Optionally, garnish with grated Parmesan cheese and fresh
                    basil leaves.
                  </li>
                </ul>
              </li>
